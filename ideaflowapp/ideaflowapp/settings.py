# Django settings for ideaflowapp project.
import os
import django
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(os.path.dirname(SITE_ROOT), 'ideaflow.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'dokr=exo(g3j=g(4ebq1*7go$!_-e91y2$bp=_k6t%20_)ia59'
...
MIDDLEWARE_CLASSES = (
    ...
    'ideaflowapp.disable.DisableCSRF', 

    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'ideaflowapp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ideaflowapp.wsgi.application'
